...
Apart from undersampling “Free” images, more action is required to handle the unbalanced data. To do so, I use either Tversky loss [3] or the Weighted BCE loss function.
